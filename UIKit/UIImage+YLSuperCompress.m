...
#import "UIImage+YLSuperCompress.h"

@implementation UIImage (YLSuperCompress)
...
+ (NSData *)yl_compressImage:(UIImage *)image toMaxLength:(NSInteger)maxLength maxWidth:(NSInteger)maxWidth{
    ...
    CGSize newSize = [self yl_scaleImage:image withLength:maxWidth];
    UIImage *newImage = [self yl_resizeImage:image withNewSize:newSize];
